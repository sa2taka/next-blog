...
上記の2つの点から**仕様からテストを生成すればいい**と考え、今に至ります。個人的には仕様駆動テスト・Specified Driven Testとかカッコつけていってますが、当たり前のことを言っているまでです。今は、「実装はテストを満たす最もシンプルなコードである」という考え方になってます（アインシュタインの「Everything should be made as simple as possible, but not simpler.」も添えて）。
