...
const Guide = () => {
  ...
  return (
    <GuideRoot>
      ...
      <h2>筆者について</h2>
      <p>当サイトの作者・管理者は「sa2taka」(別名：とっぷら。以下、筆者)です</p>
      <p>
        当サイト、または筆者自身への問い合わせは、下記Twitterへのリプライ、ダイレクトメッセージにて受け付けています。
      </p>
      <ul>
        <li>
          <a href="https://twitter.com/t0p_l1ght">筆者のTwitterアカウント</a>
        </li>
      </ul>
      <h2>推奨環境</h2>
